...
from ..models import Pedido, InventarioProducto, Lote
...
class HomePage(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["inventario"]= InventarioProducto.objects.all()[:10]#aqui obtengo los primeros diez productos del inventario
